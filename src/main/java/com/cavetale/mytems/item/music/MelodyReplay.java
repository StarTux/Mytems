...
public final class MelodyReplay {
    ...
    public MelodyReplay(final Melody melody, final Function<Beat, Boolean> beatCallback) {
    ...
    public static MelodyReplay play(Melody melody, Player player) {
        MelodyReplay result = new MelodyReplay(melody, beat -> {
    ...
    public static MelodyReplay play(Melody melody, Location location, double range) {
        MelodyReplay result = new MelodyReplay(melody, beat -> {
    ...
    public void start() {
        ...
        task = Bukkit.getScheduler().runTaskTimer(MytemsPlugin.getInstance(), this::run, 0L, 1L);
    }
