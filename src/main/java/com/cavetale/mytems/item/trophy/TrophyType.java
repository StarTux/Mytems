...
public enum TrophyType implements ComponentLike {
    ...
    // Spleef
    GOLD_SPLEEF(Mytems.GOLDEN_SPLEEF_SHOVEL, SPLEEF, GOLD),
    SILVER_SPLEEF(Mytems.SILVER_SPLEEF_SHOVEL, SPLEEF, SILVER),
    BRONZE_SPLEEF(Mytems.BRONZE_SPLEEF_SHOVEL, SPLEEF, BRONZE),
    PARTICIPATION_SPLEEF(Mytems.BLUE_SPLEEF_SHOVEL, SPLEEF, PARTICIPATION),
    // Shovel
